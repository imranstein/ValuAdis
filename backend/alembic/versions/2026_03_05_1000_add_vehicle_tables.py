...
def upgrade():
    ...
    op.create_table('vehicles',
        ...
        sa.Column('body_type', sa.Enum('sedan', 'suv', 'hatchback', 'pickup', 'truck', 'van', 'coupe', 'convertible', 'station_wagon', name='vehicle_type', create_type=False), nullable=True),
        sa.Column('fuel_type', sa.Enum('gasoline', 'diesel', 'hybrid', 'electric', 'lpg', 'cng', name='fuel_type', create_type=False), nullable=True),
        sa.Column('transmission', sa.Enum('manual', 'automatic', 'cvt', name='transmission_type', create_type=False), nullable=True),
    ...
    op.create_table('vehicle_valuations',
        ...
        sa.Column('status', sa.Enum('draft', 'pending', 'approved', 'rejected', 'expired', 'under_review', name='vehicle_valuation_status', create_type=False), nullable=False),
