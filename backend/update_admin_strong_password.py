#!/usr/bin/env python3
"""Update admin password to meet validation requirements"""
...
async def update_admin_password():
    """Update admin password to meet validation"""
    db = SessionLocal()
    try:
        # Get admin user
        ...
        if admin:
            # Update password to meet validation: 8 chars, uppercase, digit, special char
